...
public interface ConflictResolver {
     ...
     * @return Danh sách các xung đột, mỗi xung đột gồm 2 ScheduleEntry chồng chéo nhau
     */
    ...
    class Conflict {
        ...
        public String toString() {
            // Sử dụng phương thức getTitle() từ ScheduleEntry để có tên đẹp
            return "Xung đột giữa \"" + a.getType() + "\" và \"" + b.getType() + "\"";
        }
    }
    ...
    class ResolutionOption {
         ...
         public String actionCode;  // Mã hành động: "AUTO_RESOLVE", "KEEP_A", "KEEP_B"

         public ResolutionOption(String description, String actionCode) {
    ...
    class ResolutionResult {
        ...
        public ResolutionResult(boolean success, String message) { 
